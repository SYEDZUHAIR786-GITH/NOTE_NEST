    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div className="card" style={{ padding: '2.5rem 2rem', background: '#121824', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 16 }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                ...
                <a href="#forgot" style={{ fontSize: '0.78rem', color: '#22c55e', textDecoration: 'none', fontWeight: 600 }}>Forgot password?</a>
              </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', margin: '1.75rem 0', color: '#64748b', fontSize: '0.75rem' }}>
            <div style={{ flex: 1, height: 1, background: 'rgba(255, 255, 255, 0.08)' }} />
            <span style={{ padding: '0 0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>OR CONTINUE WITH</span>
            <div style={{ flex: 1, height: 1, background: 'rgba(255, 255, 255, 0.08)' }} />
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.85rem', color: '#94a3b8' }}>
          ...
          <Link to="/register" style={{ color: '#22c55e', textDecoration: 'none', fontWeight: 700 }}>
            Sign up for free
          </Link>
        </div>
      </div>
